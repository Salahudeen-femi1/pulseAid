...
export default function About() {
    return (
        <>
            <div className='bg-white flex flex-col md:flex-row lg:flex-row items-center justify-center gap-4 lg:gap-6 lg:px-10 min-h-70 lg:min-h-30 w-auto  rounded-[10px] border border-stroke m-14 shadow-lg '>
                <div className='flex flex-col gap-1'>
                    <label htmlFor="bloodGroup" className="font-semibold">Blood group</label>
                    <select id="bloodGroup" className='flex items-center gap-1 border border-stroke bg-fadedPrimary px-2 py-3 w-80 lg:w-100 outline-0 rounded-[10px]' >
                ...
                <div className='flex flex-col gap-1'>
                    ...
                    <span className='flex items-center gap-1 border border-stroke bg-fadedPrimary rounded-[10px] px-2 py-3 w-80 lg:w-100'>
                ...
                <button className='bg-primary text-white font-semibold w-50 h-13 rounded-md mt-3 lg:mt-5 flex items-center justify-center gap-2'> 
